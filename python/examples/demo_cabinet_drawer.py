...
def main() -> None:
    ...
    if args.visualize:
        ...
        CabinetVisualizer(
            ...
            [
                TrajectoryCase(
                    "RM-CCA: arm first, then base assistance (0.15 m drawer)",
            ...
            markdown=(
                ...
                "drawer goal and a ±0.15 rad arm operating envelope. The arm moves "
                "first; only after it reaches the boundary does the floating base "
                "supply the remaining drawer motion. A frozen-base PARTIAL plan is "
                "checked in the example assertions but is not rendered separately."
            ),
        )
